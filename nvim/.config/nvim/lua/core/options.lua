...
-- use undofile instead of swap/backup
...
-- Netrw config
vim.g.netrw_keepdir = 0                 -- sync current and the browsing directory
vim.g.netrw_winsize = 30                -- change the size of Netrw window to 30% when it creates a split
vim.g.netrw_banner = 0                  -- hide the banner (hit I to show it)
